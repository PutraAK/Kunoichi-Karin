...
(function () {
...

  {
    ...
    MPPlugin.EquippingFontSize = Number(
      parameters["Equipping Font Size"] || 24
    );
  ...
  Window_ShopStatus.prototype.drawActorEquipInfo = function (x, y, actor) {
    ...
    if (this._enabled && row < maxRow) {
      ...
      if (row < maxRow) this.drawParameters(x, y + row * height, maxRow - row);
    }
  };
  ...
  //
  Window_ShopStatus.prototype.drawCharacter = function (
    characterName,
    characterIndex,
    x,
    y
  ...
  Window_ShopStatus.prototype.drawActorCharacter = function (actor, x, y) {
    ...
    if (this._createDrawer) {
      this.createActorCharacterDrawer(
        actor,
        x,
        y,
        this._enabled,
  ...
  Window_ShopStatus.prototype.createActorCharacterDrawer = function (
    actor,
    x,
    y,
    enabled,
