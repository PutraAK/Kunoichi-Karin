...
(function () {
  ...
  var pSelectOverLastSpace = toBoolean(
    parameters["selectOverLastSpace"],
    false
  );
   ...
   * ●選択中の要素の有効判定
   */
  var _Window_Selectable_isCurrentItemEnabled =
    Window_Selectable.prototype.isCurrentItemEnabled;
