...
(function () {
  ...
  Game_Interpreter.prototype.setupChoices = function (params) {
    ...
    if (data.choices.length > 0) {
      ...
      $gameMessage.setChoiceCallback(
        (n) => (this._branch[this._indent] = data.results[n])
      );
    } else {
  ...
  Game_Interpreter.prototype.evalChoice = function (formula) {
    try {
      ...
      var formula2 = formula.replace(/v\[(\d+)\]/g, (match, p1) =>
  ...
  Window_ChoiceList.prototype.processCancel = function () {
    ...
    if (
      ...
      var _super =
        Alias.WiChLi_processCancel || Window_Command.prototype.processCancel;
      _super.apply(this, arguments);
    }
  };
  ...
  Window_Message.prototype.processNewLine = function (textState) {
    ...
    var _super =
      Alias.WiMe_processNewLine || Window_Base.prototype.processNewLine;
    _super.apply(this, arguments);
  };
