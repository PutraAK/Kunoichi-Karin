...
(function () {
  ...
  var turnWindowUseSprite = String(
    parameters["Turn Window Use Sprite"] || "true"
  );
  ...
  var turnWindowFontSizeTurn = Number(
    parameters["Turn Window Font Size Turn"] || 24
  );
  var turnWindowFontSizeCount = Number(
    parameters["Turn Window Font Size Count"] || 48
  );
  ...
  var _turnw_Scene_Battle_createAllWindows =
  ...
  Scene_Battle.prototype.update = function () {
    ...
    if (this._turnWindow._turnCount !== BattleManager.twTurnCount()) {
      this._turnWindow.refresh();
    }
  };

  var _turnw_Window_BattleLog_windowWidth =
  ...
  Window_BattleLog.prototype.windowWidth = function () {
    ...
    if (turnWindowSplitLog == "true") {
      width -= turnWindowWidth;
    }
    return width;
  };
  ...
  if (Imported.YEP_BattleEngineCore) {
    ...
    var _turnw_Scene_Battle_commandAttack =
