...
(function () {
  var MPPlugin = {
    params: PluginManager.parameters("MPP_HighlightActiveWindow"),
  };

  MPPlugin.BackBlendColor = MPPlugin.params["Back Blend Color"]
    .split(",")
    .map(Number);
  MPPlugin.FrameBlendColor = MPPlugin.params["Frame Blend Color"]
    .split(",")
    .map(Number);
