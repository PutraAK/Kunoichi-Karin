...
(function () {
  ...
  Game_Actor.prototype.getBustImageData = function () {
    ...
    return {
      name: name,
      scaleX: parseInt(
        this.getMetaInfoForBustImage(["画像拡大率X", "ImageScaleX"])
      ),
      scaleY: parseInt(
        this.getMetaInfoForBustImage(["画像拡大率Y", "ImageScaleY"])
      ),
