...
(function () {
  ...
  // パラメータの取得と整形
  //=============================================================================
  var paramBoatPassableRegions = getParamArrayNumber(
    ["BoatPassableRegions", "小型船通行リージョン"],
    0
  );
  var paramBoatPassableTerrainTags = getParamArrayNumber(
    ["BoatPassableTerrainTags", "小型船通行地形タグ"],
    0
  );
  var paramBoatNonPassableRegions = getParamArrayNumber(
    ["BoatNonPassableRegions", "小型船不可リージョン"],
    0
  );
  var paramBoatNonPassableTerrainTags = getParamArrayNumber(
    ["BoatNonPassableTerrainTags", "小型船不可地形タグ"],
    0
  );
  var paramShipPassableRegions = getParamArrayNumber(
    ["ShipPassableRegions", "大型船通行リージョン"],
    0
  );
  var paramShipPassableTerrainTags = getParamArrayNumber(
    ["ShipPassableTerrainTags", "大型船通行地形タグ"],
    0
  );
  var paramShipNonPassableRegions = getParamArrayNumber(
    ["ShipNonPassableRegions", "大型船不可リージョン"],
    0
  );
  var paramShipNonPassableTerrainTags = getParamArrayNumber(
    ["ShipNonPassableTerrainTags", "大型船不可地形タグ"],
    0
  );
  var paramAirShipNonPassableRegions = getParamArrayNumber(
    ["AirShipNonPassableRegions", "飛行船不可リージョン"],
    0
  );
  var paramAirShipNonPassableTerrainTags = getParamArrayNumber(
    ["AirShipNonPassableTerrainTags", "飛行船不可地形タグ"],
    0
  );
  var paramBoatRidingTerrainTags = getParamArrayNumber(
    ["BoatRidingTerrainTags", "小型船乗降地形タグ"],
    0
  );
  var paramBoatRidingRegions = getParamArrayNumber(
    ["BoatRidingRegions", "小型船乗降リージョン"],
    0
  );
  var paramShipRidingTerrainTags = getParamArrayNumber(
    ["ShipRidingTerrainTags", "大型船乗降地形タグ"],
    0
  );
  var paramShipRidingRegions = getParamArrayNumber(
    ["ShipRidingRegions", "大型船乗降リージョン"],
    0
  );
  var paramAirShipRidingTerrainTags = getParamArrayNumber(
    ["AirShipRidingTerrainTags", "飛行船乗降地形タグ"],
    0
  );
  var paramAirShipRidingRegions = getParamArrayNumber(
    ["AirShipRidingRegions", "飛行船乗降リージョン"],
    0
  );
  ...
  Game_Map.prototype.isAirshipLandOk = function (x, y) {
    if (
      paramAirShipRidingRegions.length > 0 ||
      paramAirShipRidingTerrainTags.length > 0
    ) {
      return true;
    } else {
  ...
  Game_Vehicle.prototype.isLandOkTerrainTagAndRegion = function (
    x,
    y,
    terrainTags,
    regionIds
