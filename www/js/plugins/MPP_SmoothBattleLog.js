...
(function () {
  ...
  (function () {
    ...
    MPPlugin.AnimationNextDelay = Number(
      parameters["Animation Next Delay"] || 12
    );
    MPPlugin.AnimationShortCount = Number(
      parameters["Animation Short Count"] || 12
    );
  })();
  ...
  //303
  Alias.WiBa_processEscapeCharacter =
  ...
  Window_BattleLog.prototype.updateLogSprites = function () {
    ...
    for (var i = 0; i < this._logSprites.length; i++) {
      ...
      if (sprite.viewDuration > 0) sprite.viewDuration--;
    }
    if (this._clearDuration > 0) {
      ...
      if (this._clearDuration === 0) this.clear_mppSBL();
    } else if (this.numLines() > 0) {
      if (this._logSprites[1].viewDuration === 0) this.shiftLine();
    }
  ...
  Window_BattleLog.prototype.isFastForward = function () {
    return (
      MPPlugin.FastForwardEnabled &&
      Alias.WiBaLo_isFastForward.apply(this, arguments)
    );
  };
  ...
  Window_BattleLog.prototype.clear = function () {
    ...
    this._baseLineStack = [];
    if (MPPlugin.LogType === 0) this._clearDuration = MPPlugin.ViewDuration;
  };
  ...
  Window_BattleLog.prototype.displayAction = function (subject, item) {
    if (MPPlugin.ItemNameOnly) {
      if (
        ...
        !MPPlugin.NotDisplaySkils.contains(item.id)
      ) {
  ...
  Window_PartyCommand.prototype.makeCommandList = function () {
    ...
    if (MPPlugin.LogCommand) this.addCommand(MPPlugin.LogCommand, "battleLog");
  };
  ...
  //46
  Alias.ScBat_isAnyInputWindowActive =
    Scene_Battle.prototype.isAnyInputWindowActive;
  Scene_Battle.prototype.isAnyInputWindowActive = function () {
    return (
      Alias.ScBat_isAnyInputWindowActive.apply(this, arguments) ||
      this._logWindow.active
    );
  };

  //127
  Alias.ScBat_createDisplayObjects =
    Scene_Battle.prototype.createDisplayObjects;
  Scene_Battle.prototype.createDisplayObjects = function () {
    Alias.ScBat_createDisplayObjects.apply(this, arguments);
    if (MPPlugin.StartMessagesOnLog) BattleManager.displayStartMessagesOnLog();
  };
