...
(function () {
  ...
  Sprite_Character.prototype.makeKageM = function () {
    if (!this._character._kageM) {
      this._character.initKageM();
    }
    if (this._character._kageM._commands[this._bsId] != "make") {
      return;
    }
    if (!SceneManager._scene._spriteset) {
      return;
    }
    if (!this._character._bitmapK || !this._character._bitmapK.width) {
      return;
    }
  ...
  Sprite_Character.prototype.deleteKageM = function () {
    if (this._character._kageM._commands[this._bsId] != "del") {
      return;
    }
    if (!this._kageMSprite) {
      return;
    }
    var tilemap = SceneManager._scene._spriteset._tilemap;
  ...
  Sprite_Character.prototype.redrawKageM = function (realOnly) {
    ...
    if (realOnly && this._character._kageM._type != "real") {
      return;
    }
    if (!this._kageMSprite) {
      return;
  ...
  Sprite_Battler.prototype.makeKageM = function () {
    if (!this._battler._kageM) {
      this._battler.initKageM();
    }
    if (this._battler._kageM._commands[0] != "make") {
      return;
    }
    if (!SceneManager._scene._spriteset) {
      return;
    }
    if (!this._battler._bitmapK || !this._battler._bitmapK.width) {
      return;
    }
  ...
  Sprite_Battler.prototype.deleteKageM = function () {
    if (this._battler._kageM._commands[0] != "del") {
      return;
    }
    if (!this._kageMSprite) {
      return;
  ...
  Sprite_Battler.prototype.redrawKageM = function (realOnly) {
    ...
    if (realOnly && this._battler._kageM._type != "real") {
      return;
    }
    if (!this._kageMSprite) {
      return;
  ...
  Sprite_KageMaster.prototype.update = function () {
    ...
    // 角度　　　─影スプライトの更新
    this.rotation = $gameTemp.angleToRadian(
      $gameTemp.angleToDegree(oriSprite.rotation) + kage._angle
    );
  };
