...
(function () {
  ...
  (function () {
    ...
    MPPlugin.ScrollBarColor1 = "rgb(%1)".format(
      parameters["Scroll Bar Color1"] || "128,128,128"
    );
    MPPlugin.ScrollBarColor2 = "rgb(%1)".format(
      parameters["Scroll Bar Color2"] || "192,192,192"
    );
  ...
  Window_Selectable.prototype._updateScrollBar = function () {
    if (this._scrollBarSprite) {
      ...
      var height = this.height - this.standardPadding() * 2;
      var barY =
        Math.floor((height * topY) / maxHeight) + this.standardPadding();
