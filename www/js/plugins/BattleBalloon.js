...
(function () {
  ...
  //=============================================================================
  var param = {};
  param.balloonIdEvasion = getParamNumber([
    "BalloonIdEvasion",
    "回避フキダシID",
  ]);
  param.balloonIdReflection = getParamNumber([
    "BalloonIdReflection",
    "反射フキダシID",
  ]);
  param.balloonIdCounter = getParamNumber([
    "BalloonIdCounter",
    "反撃フキダシID",
  ]);
  param.balloonIdSubstitute = getParamNumber([
    "BalloonIdSubstitute",
    "身代わりフキダシID",
  ]);
  param.balloonSpeedRate = getParamNumber([
    "BalloonSpeedRate",
    "フキダシ速度倍率",
  ]);
  param.balloonWaitTime = getParamNumber([
    "BalloonWaitTime",
    "フキダシ待機時間",
  ]);
  ...
  Game_Interpreter.prototype.updateWaitMode = function () {
    ...
    return waiting
      ? true
      : _Game_Interpreter_updateWaitMode.apply(this, arguments);
  };
  ...
  //=============================================================================
  var _Game_Battler_performSubstitute =
  ...
  var _Game_Battler_performReflection =
  ...
  var _Game_Battler_performMagicEvasion =
  ...
  Sprite_BattlerBalloon.prototype.speed = function () {
    return Math.floor(
      (Sprite_Balloon.prototype.speed.call(this) * 100) /
        (param.balloonSpeedRate || 100)
    );
  };
