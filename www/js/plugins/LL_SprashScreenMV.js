//=============================================================================
// RPGツクールMZ - LL_SprashScreenMV.js v1.0.0
//-----------------------------------------------------------------------------
// ルルの教会 (Lulu's Church)
...
(function () {
  ...
  // 画像リスト
  var splashImages = JSON.parse(parameters["splashImages"] || "null");
  var splashImageLists = [];
  if (splashImages) {
    splashImages.forEach(function (elm) {
  ...
  Scene_SplashScreen.prototype.startFadeIn = function () {
    this._fadeSprite = null;
    Scene_Base.prototype.startFadeIn.call(this);
  };
})();
