...
(function () {
  ...
  Game_CharacterBase.prototype.increaseSteps = function () {
    ...
    var soundsHash = [
      ...
      {
        key: "regionList",
        condition: findListItem.bind(this, this.regionId()),
      },
      ...
      {
        key: "terrainTagList",
        condition: findListItem.bind(this, this.terrainTag()),
      },
  ...
  Game_CharacterBase.prototype.isInvalidFootStepSound = function () {
    return (
      !this.isPlayStepSound() ||
      $gameSystem.footstepDisable ||
  ...
  Game_Event.prototype.initialize = function () {
    ...
    this._footStepSeName =
      getMetaValues(this.event(), ["FootStep", "足音"]) || null;
