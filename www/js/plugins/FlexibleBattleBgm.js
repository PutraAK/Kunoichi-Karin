...
(function () {
  ...
  var convertEscapeCharacters = function (text) {
    if (
      typeof Game_Interpreter.prototype.pluginCommandBook_unescape ===
      "function"
    ) {
  ...
  Game_Interpreter.prototype.pluginCommandFlexibleBattleBgm = function (
    command,
    args
  ) {
  ...
  Game_System.prototype.addTroopBattleBgm = function (
    start,
    end,
    name,
    volume,
    ...
    this._troopsBattleBgm[start + ":" + end] = {
      name: name,
