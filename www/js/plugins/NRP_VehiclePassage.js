...
(function () {
  ...
  const pAirshipSameAsCharacters = toBoolean(
    parameters["AirshipSameAsCharacters"],
    false
  );
  ...
  // リストを全連結
  const pSettingList = pBoatSettingList
    .concat(pShipSettingList)
    .concat(pAirshipSettingList);
