...
/*:
 * @plugindesc 在庫システムを有するお店を設定します。version 1.04m2
 * @author Suppon
 *
 ...
 * また、必ずパラメータのDisplay option (在庫数表示) を true にしてください。
 *
 * 以下のようにプラグインコマンドを入力して使用してください。
