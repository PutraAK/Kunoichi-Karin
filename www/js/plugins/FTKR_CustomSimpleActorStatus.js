...
(function () {
  ...
  if (xparamName) {
    FTKR.CSS.cssStatus.xparam = Object.entries(xparamName).map(function (obj) {
      return obj[1];
    });
  } else {
  ...
  if (sparamName) {
    FTKR.CSS.cssStatus.sparam = Object.entries(sparamName).map(function (obj) {
      return obj[1];
    });
  } else {
      ...
      for (var i = 0; i < datas.length; i++) {
        ...
        switch (match[1].toUpperCase()) {
          ...
          case "色":
            ...
            obj.cssGauges[dataId].color2 = colors[1]
              ? Number(colors[1])
              : Number(colors[0]);
            break;
        }
  ...
  var _CSS_Game_Interpreter_pluginCommand =
  ...
  Game_Interpreter.prototype.cssChangeWindowSettingParam = function (
    param,
    args
  ) {
    if (!param) return;
  ...
  Game_Actor.prototype.setupCssbgi = function (
    imageId,
    name,
    x,
    y,
  ...
  /*-------------------------------------------------------------
    ...
    lss   :簡易ステータスオブジェクト
    -------------------------------------------------------------*/
  Window_Base.prototype.drawCssActorStatus = function (
    index,
    actor,
    x,
    y,
  ...
  Window_Base.prototype.drawCssActorStatus_v2 = function (
    index,
    actor,
    x,
    y,
  ...
  /*-------------------------------------------------------------
    ...
    lss         :簡易ステータスオブジェクト
    -------------------------------------------------------------*/
  Window_Base.prototype.drawCssActorStatusText = function (
    index,
    actor,
    x,
    y,
    ...
    if (lss && lss.statusList) {
      ...
      this.drawCssActorStatusText_v2(
        index,
        actor,
        x,
        y,
  ...
  Window_Base.prototype.parseIntCssStatus = function (
    value,
    x,
    y,
    width,
  ...
  Window_Base.prototype.drawCssActorStatusText_v2 = function (
    index,
    actor,
    x,
    y,
    ...
    statusnames.forEach(function (status) {
      line += this.drawCssActorStatusBases(
        index,
        actor,
        x,
        y + dy * line,
  ...
  Window_Base.prototype.drawCssActorStatusBases = function (
    index,
    actor,
    x,
    y,
    ...
    if (lss && lss.statusList) {
      ...
      return this.drawCssActorStatusBases_v2(
        index,
        actor,
        x,
        y,
  ...
  Window_Base.prototype.drawCssActorStatusBases_v2 = function (
    index,
    actor,
    x,
    y,
  ...
  Window_Base.prototype.drawCssActorStatusBase = function (
    ...
    var match = status.match(/([^\(]+)\((.+)\)/);
    if (match) {
      return this.drawCssActorStatusBase_A(
        index,
        actor,
        x,
        y,
      ...
      return this.drawCssActorStatusBase_B(
        index,
        actor,
        x,
        y,
  ...
  // 括弧で表示する内容を指定する表示コード
  Window_Base.prototype.drawCssActorStatusBase_A = function (
    index,
    actor,
    x,
    y,
    ...
    switch (match[1].toUpperCase()) {
      ...
      default:
        ...
        return this.drawCssActorStatusBase_A1(
          index,
          actor,
          x,
          y,
  ...
  Window_Base.prototype.drawCssActorStatusBase_A1 = function (
    index,
    actor,
    x,
    y,
    ...
    switch (match[1].toUpperCase()) {
      ...
      case "EAOP":
        return this.drawCssActorEquipAopParam(
          actor,
          x,
          y,
          width,
      ...
      case "CUSTOM":
        return this.drawCssActorCustom(
          actor,
          x,
          y,
          width,
  ...
  // 括弧を使わない表示コード
  Window_Base.prototype.drawCssActorStatusBase_B = function (
    index,
    actor,
    x,
    y,
  ...
  //アイテムの設定の表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssItemParam = function (
    actor,
    x,
    y,
    width,
  ...
  //アイテムの属性
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssItemElement = function (
    actor,
    x,
    y,
    width,
    ...
    var name =
      lss.item && lss.item.damage
        ? $dataSystem.elements[lss.item.damage.elementId]
        : "";
    this.drawText(name, x, y, width);
    return 1;
  };
  ...
  //アイテムのカスタム画像の表示
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssItemImage = function (
    actor,
    dx,
    dy,
    width,
  ...
  //アクターの顔画像の表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorFace = function (
    actor,
    x,
    y,
    width,
  ...
  //アクターの歩行キャラの表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorChara = function (
    actor,
    x,
    y,
    width,
  ...
  Window_Base.prototype.drawCssChara = function (
    actor,
    dx,
    dy,
    width,
  ...
  //アクターのSV戦闘キャラの表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorSvChara = function (
    index,
    actor,
    x,
    y,
  ...
  Window_Base.prototype.drawCssSvChara = function (
    index,
    actor,
    dx,
    dy,
  ...
  Window_Base.prototype.drawCssSvSprite = function (
    index,
    actor,
    dx,
    dy,
    ...
    var offsetX =
      (this.cssSvPositionX(actor, svChara) * (width - svChara.width)) / 2;
  ...
  Window_Base.prototype.drawCssSvImage = function (
    index,
    actor,
    dx,
    dy,
  ...
  //アクターのステートアイコンの表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorIcons = function (
    index,
    actor,
    x,
    y,
  ...
  Window_Base.prototype.drawCssIconsSprite = function (
    index,
    actor,
    x,
    y,
    ...
    var offset = css.overlap
      ? this.getOverlapValue(actor, iw, maxlen, css)
      : iw;
  ...
  Window_Base.prototype.getOverlapValue = function (actor, iw, maxlen, css) {
    ...
    var diff = Math.max(
      (maxlen - iw - iconPadding) / (iconlen - 1),
      iw * css.rate
    );
    return diff && diff < iw ? diff : iw;
  };

  Window_Base.prototype.iconOverlapOffset = function (
    iw,
    number,
    width,
    vartical
    ...
    var iconPadding = FTKR.CSS.cssStatus.state.iconPadding;
    var len = vartical
      ? (number - 1) * this.lineHeight() + iconPadding
      : width - iw - iconPadding;
  ...
  Window_Base.prototype.drawCssIcon = function (iconIndex, x, y, scale, auto) {
    ...
    if (auto)
      scale = Math.min(Math.max(this.lineHeight() - iconPadding, 0) / pw, 1);
  ...
  //パラメータの表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorParam = function (
    actor,
    x,
    y,
    width,
  ...
  //素のパラメータの表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorParamBase = function (
    actor,
    x,
    y,
    width,
  ...
  //パラメータ差分の表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorParamDiff = function (
    actor,
    x,
    y,
    width,
  ...
  Window_Base.prototype.drawParamDiffValue = function (
    value,
    x,
    y,
    width,
  ...
  //追加能力値の表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorXParam = function (
    actor,
    x,
    y,
    width,
  ...
  //特殊能力値の表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorSParam = function (
    actor,
    x,
    y,
    width,
  ...
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorEquipParam = function (
    actor,
    x,
    y,
    width,
  ...
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorEquipXParam = function (
    actor,
    x,
    y,
    width,
  ...
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorEquipSParam = function (
    actor,
    x,
    y,
    width,
  ...
  //装備パラメータ差分の表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorEquipDiff = function (
    actor,
    x,
    y,
    width,
  ...
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorEquipXPDiff = function (
    actor,
    x,
    y,
    width,
  ...
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorEquipSPDiff = function (
    actor,
    x,
    y,
    width,
  ...
  //AOP能力値の表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorAopParam = function (
    actor,
    x,
    y,
    width,
  ...
  //素のAOP能力値の表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorAopParamBase = function (
    actor,
    x,
    y,
    width,
  ...
  //AOP能力値差分の表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorAopParamDiff = function (
    actor,
    x,
    y,
    width,
  ...
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorEquipAopParam = function (
    actor,
    x,
    y,
    width,
  ...
  //AOP装備パラメータ差分の表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorEquipAopDiff = function (
    actor,
    x,
    y,
    width,
    ...
    if (target) {
      var newValue = target.aopParam(paramId);
      var diffvalue = newValue - actor.aopParam(paramId);
      this.drawParamDiffValue(
        diffvalue,
        x,
        y,
        width,
        FTKR.CSS.cssStatus.ediffaop
      );
    }
    return 1;
  };
  ...
  //カスタムパラメータの表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorCustom = function (
    actor,
    x,
    y,
    width,
  ...
  //カスタムゲージの表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorGauge = function (
    actor,
    x,
    y,
    width,
  ...
  Window_Base.prototype.drawCssCurrentAndMax = function (
    labelWidth,
    current,
    max,
    x,
  ...
  //装備の表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorEquip = function (
    actor,
    x,
    y,
    width,
  ...
  //装備可否の表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssCannotEquip = function (
    actor,
    x,
    y,
    width,
  ...
  //JS評価式の表示関数
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssEval = function (
    actor,
    x,
    y,
    width,
  ...
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssActorCustomGauge = function (
    actor,
    x,
    y,
    width,
  ...
  //------------------------------------------------------------------------
  Window_Base.prototype.drawCssClassCustomGauge = function (
    actor,
    x,
    y,
    width,
  ...
  Window_Base.prototype.drawCssActorMessage = function (actor, x, y, width) {
    ...
    var text = FTKR.CSS.cssStatus.message.levelUp.format(
      actor.name(),
      actor.level,
      actor._levelUpCount
    );
  ...
  var _CSS_Window_Base_standardFontSize =
    Window_Base.prototype.standardFontSize;
  Window_Base.prototype.standardFontSize = function () {
    return this._customFontSize
      ? this._customFontSize
      : _CSS_Window_Base_standardFontSize.call(this);
  };

  var _CSS_Window_Base_standardPadding = Window_Base.prototype.standardPadding;
  Window_Base.prototype.standardPadding = function () {
    return this._customPadding >= 0
      ? this._customPadding
      : _CSS_Window_Base_standardPadding.call(this);
  };

  var _CSS_Window_Base_lineHeight = Window_Base.prototype.lineHeight;
  Window_Base.prototype.lineHeight = function () {
    return this._customLineHeight
      ? this._customLineHeight
      : _CSS_Window_Base_lineHeight.call(this);
  };

  var _CSS_Window_Base_standardBackOpacity =
    Window_Base.prototype.standardBackOpacity;
  Window_Base.prototype.standardBackOpacity = function () {
    return this._customBackOpacity >= 0
      ? this._customBackOpacity
      : _CSS_Window_Base_standardBackOpacity.call(this);
  };
  ...
  Window_Selectable.prototype.spacing = function () {
    return this._customSpacing !== undefined
      ? this._customSpacing
      : _CSS_Window_Selectable_spacing.call(this);
  };
  ...
  Window_Selectable.prototype.maxCols = function () {
    return this._customMaxCols
      ? this._customMaxCols
      : _CSS_Window_Selectable_maxCols.call(this);
  };
  ...
  Window_Selectable.prototype.itemWidth = function () {
    return Math.floor(
      (this.width - this.padding * 2 + this.customSpacing()) /
        this.customMaxCols() -
        this.customSpacing()
    );
  };
  ...
  var _CSS_Window_Selectable_maxPageRows =
    Window_Selectable.prototype.maxPageRows;
  ...
  Window_Selectable.prototype.topRow = function () {
    return this.itemHeightSpace() !== undefined
      ? Math.floor(this._scrollY / this.unitHeight())
  ...
  FTKR.CSS.Sprite_Actor_updateTargetPosition =
